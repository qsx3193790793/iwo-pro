                ...
                <template v-for="(v,i) in item.items">
                  <Col v-if="(!v.isShow)||v.isShow({vm})" :class="{'is-hidden':v.isHidden,[v.type]:!0,[(!v.resize||v.resize==='none')&&`mine-row-${v.type==='textarea'?v.row:1}`]:!['divider-line','divider-empty'].includes(v.type),[`mine-row-divider-empty`]:['divider-empty'].includes(v.type)}" :key="i" :span="(v.col||8)">
                    <FormItem :key="v.key+v.name" :prop="v.key" :key-value="v.key" :class="v.class" :style="v.style" :rules="getRules(v)" :required="v.isRequire">
                      ...
                      <Input v-if="['input','FMInput'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请输入')" :maxlength="v.maxlength??30" autocomplete="off" :clearable="v.clearable??true" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" @change="v.onChange&&v.onChange({vm,item:v})" @keydown.enter.native="v.onChange&&v.onChange({vm,item:v})">
                      ...
                      <Input v-else-if="['textarea','FMTextarea'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :ref="v.key" type="textarea" :rows="v.rows??2" :maxlength="v.maxlength==0?null:v.maxlength" :show-word-limit="!!v.maxlength" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请输入')" :clearable="v.clearable??true" :resize="v.resize||'none'" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" @change="v.onChange&&v.onChange({vm,item:v})"/>
                      <InputNumber v-else-if="['number','FMNumber'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :precision="v.precision??0" :min="$$getVariableType(v.min)==='[object Function]'?v.min({vm}):v.min" :max="$$getVariableType(v.max)==='[object Function]'?v.max({vm}):v.max" :controls="!0" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请输入')" :clearable="v.clearable??true" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" @change="v.onChange&&v.onChange({vm,item:v})"/>
                      <Autocomplete v-else-if="['inputAutocomplete','FMInputAutocomplete'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" value-key="name" :fetch-suggestions="v.suggestions&&v.suggestions({vm,options:v.options})" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请输入')" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :clearable="v.clearable??true" @select="v.onChange&&v.onChange({vm,item:v})" @change="v.onChange&&v.onChange({vm,item:v})">
                        <template #default="{ item }">
                          <div class="autocomplete-name" :title="item.name">{{ item.name }}</div>
                        </template>
                      </Autocomplete>
                      <Select v-else-if="['remoteSelect','FMRemoteSelect'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请输入')" :clearable="v.clearable??true" :required="v.isRequire" :multiple="v.multiple??!1" filterable remote :remote-method="(query)=>v.remoteMethod&&v.remoteMethod({vm,options:v.options,query})" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" collapse-tags @change="v.onChange&&v.onChange({vm,item:v})">
                        <Option v-for="vv in getSelectOptions(v)" :key="vv.label+vv.value+i" :label="vv.label" :value="vv.value" :disabled="vv.disabled"></Option>
                      </Select>
                      <Cascader v-else-if="['cascader','FMCascader'].includes(v.type)" v-loading="v.loading" v-bind="Object.assign({},getName(v.attrs),{expandTrigger:'hover'}) " v-model="formData[v.key]" :ref="v.key" :options="getSelectOptions(v)" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :clearable="v.clearable??true" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" filterable collapse-tags collapse-tags-tooltip @change="v.onChange&&v.onChange({vm,item:v})"></Cascader>
                      <Select v-else-if="['select','FMSelect'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :clearable="v.clearable??true" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" filterable @change="v.onChange&&v.onChange({vm,item:v})">
                      ...
                      <Select v-else-if="['multipleSelect','FMMultipleSelect'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :clearable="v.clearable??true" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" multiple collapse-tags filterable @change="v.onChange&&v.onChange({vm,item:v})">
                      ...
                      <DatePicker v-else-if="['datePicker','FMDatePicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format" :value-format="v.valueFormat||'yyyy-MM-dd'" type="date" :clearable="v.clearable??true" :editable="!1" @change="v.onChange&&v.onChange({vm,item:v})"></DatePicker>
                      <DatePicker v-else-if="['datesPicker','FMDatesPicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format" :value-format="v.valueFormat||'yyyy-MM-dd'" type="dates" :clearable="v.clearable??true" :editable="!1" @change="v.onChange&&v.onChange({vm,item:v})"></DatePicker>
                      <DatePicker v-else-if="['dateRangePicker','FMDateRangePicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format||'yyyy-MM-dd'" :value-format="v.valueFormat||'yyyy-MM-dd'" type="daterange" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" :clearable="v.clearable??true" :editable="!1" unlink-panels @change="v.onChange&&v.onChange({vm,item:v})"></DatePicker>
                      <DatePicker v-else-if="['monthPicker','FMMonthPicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format||'yyyy-MM'" :value-format="v.valueFormat||'yyyy-MM'" type="month" :clearable="v.clearable??true" :editable="!1" @change="v.onChange&&v.onChange({vm,item:v})"></DatePicker>
                      <DatePicker v-else-if="['monthsPicker','FMMonthsPicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format||'yyyy-MM'" :value-format="v.valueFormat||'yyyy-MM'" type="months" :clearable="v.clearable??true" :editable="!1" @change="v.onChange&&v.onChange({vm,item:v})"></DatePicker>
                      <DatePicker v-else-if="['monthRangePicker','FMMonthRangePicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format||'yyyy-MM'" :value-format="v.valueFormat||'yyyy-MM'" type="monthrange" :clearable="v.clearable??true" :editable="!1" unlink-panels @change="v.onChange&&v.onChange({vm,item:v})"></DatePicker>
                      <DatePicker v-else-if="['yearPicker','FMYearPicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format||'yyyy'" :value-format="v.valueFormat||'yyyy'" type="year" :readonly="v.readonly??false" :clearable="v.clearable??true" :editable="!1" @change="v.onChange&&v.onChange({vm,item:v})"></DatePicker>
                      ...
                      <DatePicker v-else-if="['dateTimePicker','FMDateTimePicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format||'yyyy-MM-dd HH:mm:ss'" :value-format="v.valueFormat||'yyyy-MM-dd HH:mm:ss'" type="datetime" :clearable="v.clearable??true" :editable="!1" @change="v.onChange&&v.onChange({vm,item:v})"></DatePicker>
                      <DatePicker v-else-if="['dateTimeRangePicker','FMDateTimeRangePicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format||'yyyy-MM-dd HH:mm:ss'" :value-format="v.valueFormat||'yyyy-MM-dd HH:mm:ss'" type="datetimerange" :clearable="v.clearable??true" :editable="!1" unlink-panels @change="v.onChange&&v.onChange({vm,item:v})"></DatePicker>
                      <TimePicker v-else-if="['timePicker','FMTimePicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format||'HH:mm:ss'" :value-format="v.valueFormat||'HH:mm:ss'" :clearable="v.clearable??true" :editable="!1" @change="v.onChange&&v.onChange({vm,item:v})"></TimePicker>
                      <TimePicker v-else-if="['timeRangePicker','FMTimeRangePicker'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" start-placeholder="开始日期" end-placeholder="结束日期" :pickerOptions="{disabledDate:(d)=>v.disabledDate?.({vm,d})}" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :format="v.format||'HH:mm:ss'" :value-format="v.valueFormat||'HH:mm:ss'" :clearable="v.clearable??true" :editable="!1" is-range unlink-panels @change="v.onChange&&v.onChange({vm,item:v})"></TimePicker>
                      <TimerSelector v-else-if="['timerSelector','FMTimerSelector'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :placeholder="(v.isDisable||disabled)?'':(v.placeholder||'请选择')" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" @change="v.onChange&&v.onChange({vm,item:v,value:$event})"></TimerSelector>
                      <RadioGroup v-else-if="['radio','FMRadio'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" :max="v.max" @change="v.onChange&&v.onChange({vm,item:v})">
                      ...
                      <CheckboxGroup v-else-if="['checkbox','FMCheckbox'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" :required="v.isRequire" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)" @change="v.onChange&&v.onChange({vm,item:v})">
                      ...
                      <component v-else-if="['component','FMComponent'].includes(v.type)" v-loading="v.loading" v-model="formData[v.key]" v-on="v.emitter?.({vm,item:v})" v-bind="v.attrs||{}" :options="v.options&&getSelectOptions(v)" :ref="v.key" :root="{vm,item:v}" :is="v.component" :disabled="disabled||($$getVariableType(v.isDisable)==='[object Function]'?v.isDisable({vm}):v.isDisable)"></component>
