      ...
      <div class="table-panel one-screen-fg1">
        ...
        <JsTable :dataSource="list" :columns="columns">
          ...
          <template #workorderType="{row}">
            {{ proxy.$store.getters['dictionaries/MATCH_LABEL']('work_order_type', row.workorderType) }}
          </template>
...
export default {
  name: 'TemplateIndex',
  cusDicts: ['work_order_type', 'template_status_name', 'template_big_type', 'template_small_type', 'base_province_code']
}
</script>
