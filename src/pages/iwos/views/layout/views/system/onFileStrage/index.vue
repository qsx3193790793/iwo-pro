        ...
        {col: 6, type: "divider-empty"},
        {
          ...
          items: [
            ...
            },
            {
              ...
              col: 1,
              permission: ['config:fileStrage:delete'],
              onClick: ({vm}) => {
                this.handleDelete();
              },
            },
            {
              ...
              attrs: {type: "success"},
              col: 1,
              permission: ['config:fileStrage:add'],
              onClick: ({vm}) => {
                this.getSourceTree();
                this.handleAdd();
              },
    ...
    handleStart(row) {
      this.$$Dialog
          ...
          .then(() => {
            ...
            return this.$$api.complaintOnFileStrategy.statusOnFileStrategy({data: data});
          })
          .then(({res, err}) => {
            if (err) return;
            this.getList();
    ...
    handleDelete(row) {
      ...
      this.$$Dialog
          ...
          .then(() => {
            ...
            return this.$$api.complaintOnFileStrategy.delteOnFileStrategy({
