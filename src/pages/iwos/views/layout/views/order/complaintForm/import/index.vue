<template>
  <div class="import-container">
    <MDialog v-bind.sync="$attrs" v-on="$listeners" ref="MDialogRef" width="30%" top="20vh" height="40%"
      ...
      <el-upload class="upload-demo" drag :action="importUrl" :accept="accept" :headers="headers" :limit="limit+1"
                 ...
                 ref="uploadRef" :on-change="fileChange" :data="otherData" :httpRequest="httpRequest" :multiple="multiple">
...
function handleBeforeUpload(file) {
  console.log('file handleBeforeUpload', file);
}
...
function fileChange(file, fl) {
  // uploadRef.value.clearFiles();
  console.log('file filechange', file, fl);
  if (!props.multiple) {
    fileList.value = [fl[fl.length - 1]];
  }
